...
$messages = [
    ...
    "physicalserver_connection_stepsbefore" => "Before connecting to the OpenVZ-Server there must be executed several commands. With this commands the system is updated and some needed software packages will be installed.",
