...
$messages = [
    ...
    "physicalserver_connection_stepsbefore" => "Bevor die Verbindung mit dem OpenVZ-Server aufgebaut werden kann, müssen auf darauf folgende Befehle ausgeführt werden. Damit wird das System aktualisiert und es werden nötige Software-Pakete installiert.",
